function [model] = constrainModelRFASTCORMICS(model, medium_mets, not_medium_constrained, biomass_rxn, function_keep)
...
[exRxns, Ex_orgaInd] = findEXRxnsRFASTCORMICS(model, biomass_rxn, function_keep);
